...
import { AgentNotifications, AdminNotifications, ClientNotifications } from "../pages/shared/Notifications";
...
<Routes>
    ...
    <Route path="/agent/my-stats" element={<MyPerformance />} />
    <Route path="/agent/clients"  element={<MyClients />} />
